...
dog2 = Dog.new(name: "Heidi", breed: "Dackel", age: 7, user_id: antonio.id, address: "Zimmerstraße 68, 10117 Berlin", cuddliness: rand(1..5), details: "Heidi is a lively and charming Dachshund, known for her playful antics and affectionate nature that melts hearts. Her small size belies her bold personality, making her a delightful companion.")
dog = create_dog("https://res.cloudinary.com/dbak464dw/image/upload/v1685613437/qdcvtitcxemcjq7qfpn8.jpg", dog2)
dog.save

dog3 = Dog.new(name: "Henry", breed: "Dackel", age: 2, user_id: antonio.id, address: "Charlottenstraße 1, 10969 Berlin", cuddliness: rand(1..5), details: "Henry is a mischievous and playful Dachshund. Despite his small size, he has a big personality. Henry loves to burrow into blankets and enjoys engaging in hilarious antics that keep his family entertained. He may not be the cuddliest at first, but once you get to know him, cuddles are all he'll want!")

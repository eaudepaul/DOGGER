...
dog = Dog.new(name: "Emma", breed: "Golden Retriever", age: 13, user_id: antonio.id, address: "Taubenstraße 30, 10117 Berlin", cuddliness: rand(1..5), details: "Emma is a cheerful and affectionate golden retriever. She is known for her gentle nature and unwavering love for her cute batch 1217 devs. Emma is a natural therapy dog, bringing joy to everyone she meets.")
dog = create_dog("https://res.cloudinary.com/dbak464dw/image/upload/v1685612409/l4v4npefec2fevbqgtqk.jpg", dog)
dog.save

dog = Dog.new(name: "Heidi", breed: "Dackel", age: 7, user_id: paul.id, address: "Zimmerstraße 68, 10117 Berlin", cuddliness: rand(1..5), details: "Heidi is a lively and charming Dachshund, known for her playful antics and affectionate nature that melts hearts. Her small size belies her bold personality, making her a delightful companion.")
dog = create_dog("https://res.cloudinary.com/dbak464dw/image/upload/v1685613437/qdcvtitcxemcjq7qfpn8.jpg", dog)
dog.save

dog = Dog.new(name: "Henry", breed: "Dackel", age: 2, user_id: paul.id, address: "Charlottenstraße 1, 10969 Berlin", cuddliness: rand(1..5), details: "Henry is a mischievous and playful Dachshund. Despite his small size, he has a big personality. Henry loves to burrow into blankets and enjoys engaging in hilarious antics that keep his family entertained. He may not be the cuddliest at first, but once you get to know him, cuddles are all he'll want!")
dog = create_dog("https://res.cloudinary.com/dbak464dw/image/upload/v1685611688/IMG_2158_vho4pt.jpg", dog)
dog.save

dog = Dog.new(name: "Paul", breed: "Irish Setter", age: 1, user_id: paul.id, address: "Puttkamerstraße 13, 10969 Berlin", cuddliness: rand(1..5), details: "Paul is a vibrant and friendly Irish Setter with a playful spirit. With a beautiful red coat and an outgoing personality, Paul loves outdoor adventures and is a quick learner. A loyal and affectionate companion, Paul brings joy to any family, and a few jokes too!")
dog = create_dog("https://res.cloudinary.com/dbak464dw/image/upload/v1685612419/pfnwbgeezi0lcb0fseoq.jpg", dog)
dog.save

dog = Dog.new(name: "Baran", breed: "Fluffball", age: 3, user_id: paul.id, address: "Jägerstraße 67, 10117 Berlin", cuddliness: rand(1..5), details: "Baran is a loyal and protective Fluffball. He is known for his boundless energy and enthusiasm. Baran is a great companion for an active family, always ready for a long walk or an exciting game of fetch. He can also advise you on your finances. 💶")
dog = create_dog("https://res.cloudinary.com/dbak464dw/image/upload/v1685612054/rzmme26tzuoe0apkni4b.jpg", dog)
dog.save

dog = Dog.new(name: "Toni", breed: "Chihuahua", age: 5, user_id: paul.id, address: "Markgrafenstraße 20, 10969 Berlin", cuddliness: rand(1..5), details: "Antonio is a spunky and confident Chihuahua, full of personality and sass, who has a big heart and loves JavaScript. His loyalty and protective nature make him a devoted companion, always ready to shower his loved ones with affection. Eleganza!")
dog = create_dog("https://res.cloudinary.com/dbak464dw/image/upload/v1685612349/zvwvr3wkuczw7qahuatc.jpg", dog)
dog.save

dog = Dog.new(name: "Lotte", breed: "Beagle", age: 8, user_id: paul.id, address: "Friedrichstraße 43-45, 10117 Berlin", cuddliness: rand(1..5), details: "Lotte is a friendly and sociable Beagle. She has an incredible sense of smell and loves to follow her nose, often leading her to exciting adventures. Lotte's charm and affable nature make her a favorite among both children and adults. She's also a pro at geocoding.")
...
dog = Dog.new(name: "Memo", breed: "Yorkshire terrier", age: 8, user_id: paul.id, address: "Rudi-Dutschke-Straße 26, 10969 Berlin", cuddliness: 5, details: "Memo is a spirited and bold Yorkshire terrier with a larger-than-life personality. With his luxurious coat and confident demeanor, he's always ready for adventure and is a constant source of joy and entertainment for all. He loves everyone in batch 1217 and everyone in batch 1217 loves Memo!")
dog = create_dog("https://res.cloudinary.com/dbak464dw/image/upload/v1685611688/IMG_2531_dkuc1j.jpg", dog)
dog.save

dog = Dog.new(name: "Kath", breed: "Weimaraner", age: 8, user_id: paul.id, address: "Französische Str. 24, 10117 Berlin", cuddliness: rand(1..5), details: "Kath is a protective and alert Weimaraner. She is highly intelligent and has a strong sense of loyalty. Kath is the perfect watchdog, always vigilant and ready to defend you! Woof!!!")
